import AddStoryGuestPresenter from './add-story-guest-presenter.js';
import Map from '../../utils/map.js';
import { convertDataUrlToFile } from '../../data/api.js';

export default class AddStoryGuest {  #presenter;
  #stream = null;
  ...
  constructor() {
    this.#presenter = new AddStoryGuestPresenter({ view: this });
  }
  render(){
  ...
  resetForm() {
    ...
    this.startCamera = async () => {
      try {
        ...
        captureButton.addEventListener('click', handleTakePhoto);  
      } catch (error) {
    ...
    this.handleMapClick = async (latitude, longitude) => {
      try {
